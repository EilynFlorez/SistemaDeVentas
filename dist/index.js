    ...
    do { //Se repite mientras opción sea diferente de 12
        ...
        if (opcion === 1) {
            ...
            do {
                ...
                let n = Number(numPro);
                let nP = n - 1;
                if (nP >= 0 && nP < productos.length && (numPro === null || numPro === void 0 ? void 0 : numPro.toLocaleLowerCase()) !== "x") {
            ...
            } while ((numPro === null || numPro === void 0 ? void 0 : numPro.toLocaleLowerCase()) !== "x");
            if (cont) {
                ventas.push({ usuario: nombreU, productos: venta, total: suma });
        ...
        if (opcion === 3) {
            ...
            do {
                ...
                let nV = n - 1;
                if (nV >= 0 && nV < ventas.length && (numVenta === null || numVenta === void 0 ? void 0 : numVenta.toLocaleLowerCase()) !== "x") {
                    ventas.splice(nV, 1);
            ...
            } while ((numVenta === null || numVenta === void 0 ? void 0 : numVenta.toLocaleLowerCase()) !== "x");
            opcion = 0;
        }
        //Crear Producto
        if (opcion === 4) {
        ...
        if (opcion === 6) {
            ...
            do {
                ...
                let n = Number(numPro);
                let nuP = n - 1;
                if (nuP >= 0 && nuP < productos.length && (numPro === null || numPro === void 0 ? void 0 : numPro.toLocaleLowerCase()) !== "x") {
        ...
        if (opcion === 7) {
            ...
            do {
                ...
                let n = Number(numP);
                let nPr = n - 1;
                if (nPr >= 0 && nPr < productos.length && (numP === null || numP === void 0 ? void 0 : numP.toLocaleLowerCase()) !== "x") {
            ...
            } while ((numP === null || numP === void 0 ? void 0 : numP.toLocaleLowerCase()) !== "x");
            opcion = 0;
        }
        //Crear usuarios
        if (opcion === 8) {
            ...
            if (cantUsua > 0) {
                for (let i = 1; i <= cantUsua; i++) {
                    ...
                    usuarios.push({ nombre: nomU, apellido: apeU, correo: correoU, contra: contrU });
                }
        ...
        if (opcion === 10) {
            ...
            do {
                ...
                let nUsua = n - 1;
                if (nUsua >= 0 && nUsua < usuarios.length && (numUsua === null || numUsua === void 0 ? void 0 : numUsua.toLowerCase()) !== "x") {
            ...
            } while ((numUsua === null || numUsua === void 0 ? void 0 : numUsua.toLowerCase()) !== "x");
            opcion = 0;
        }
        //Eliminar Usuario
        if (opcion === 11) {
            ...
            do {
                ...
                let n = Number(numU);
                let nU = n - 1;
                if (nU >= 0 && nU < usuarios.length && (numU === null || numU === void 0 ? void 0 : numU.toLocaleLowerCase()) !== "x") {
            ...
            } while ((numU === null || numU === void 0 ? void 0 : numU.toLocaleLowerCase()) !== "x");
            opcion = 0;
        }
        //Cerrar Sesión
        if (opcion === 12) {
